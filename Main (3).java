public class Homepage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setFont(new java.awt.Font("Tw Cen MT Condensed", 0, 40)); 
    ...
    private void addCriminalActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void showrecordsActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void viewAdminRecordsActionPerformed(java.awt.event.ActionEvent evt) {
        setVisible(false);
        HomeView object = new HomeView();
        object.setVisible(true);                       
    }

    private void editrecordActionPerformed(java.awt.event.ActionEvent evt) {
        setVisible(false);
